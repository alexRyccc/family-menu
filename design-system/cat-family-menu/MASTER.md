...
**Project:** Cat Family Menu
**Generated:** 2026-08-12 23:31:43
...
|------|-----|--------------|
| Primary | `#CB543D` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#718D75` | `--color-secondary` |
| Accent/CTA | `#E2B949` | `--color-accent` |
| Background | `#F4F7F1` | `--color-background` |
| Foreground | `#203128` | `--color-foreground` |
| Muted | `#EDF4EC` | `--color-muted` |
| Border | `#DCE4DA` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#2563EB` | `--color-ring` |

**Color Notes:** Fresh-market green, tomato-red actions, and a restrained yellow accent.

### Typography

- **Heading Font:** System UI serif fallback
- **Body Font:** System UI sans-serif
- **Mood:** calm, shared household, practical, readable
